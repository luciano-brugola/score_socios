...
-- Query para replicar la tabla DWALTAS_ONLINE_DDJJ_TITULAR
select *
	into [DBPresupuestos].[dbo].[DWALTAS_ONLINE_DDJJ_TITULAR_v2]
	from [DBPresupuestos].[dbo].[DWALTAS_ONLINE_DDJJ_TITULAR]
...
alter table [DBPresupuestos].[dbo].[DWALTAS_ONLINE_DDJJ_TITULAR_v2]
